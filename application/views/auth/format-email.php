                        ...
                        <tbody>
                          <tr>
                            <td align="left" valign="middle" width="50%"><span
                                style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px">PT. Anggita Jaya</span>
                            </td>
                            <td valign="middle" width="50%" align="right" style="padding:0 0 0 10px"><span
                                style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px"><?=get_hari($hari)?>,
                                <?=tgl_indo($tgl)?></span></td>
                            <td width="1">&nbsp;</td>
                          </tr>
                        </tbody>
                      </table>
                          ...
                          <tr>
                            <td width="100%">
                              <table border="0" cellspacing="0" cellpadding="0"
                                ...
                                <tbody>
                                  <tr>
                                    <td align="center" bgcolor="#8BC34A" style="padding:20px 48px;color:#ffffff"
                                      class="banner-color">
                                      <table border="0" cellspacing="0" cellpadding="0"
                                        style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                        <tbody>
                                        ...
                                        <tbody>
                                          <tr>
                                            <td align="center" width="100%"
                                              ...
                                              <h3
                                                style="font-weight: 600; padding: 0px; margin: 0px; font-size: 16px; line-height: 24px; text-align: center;"
                                ...
                                <tbody>
                                  <tr>
                                    <td style="padding-bottom:10px 0px;;">
                                      <small
                                        style="font-weight:200;font-family:Helvetica,Arial,sans-serif;font-size:8pt;color:#2C3A47">Keterangan
                                        : Abaikan email ini jika Anda tidak merasa melakukan registrasi.</small>
                                    </td>
                                  </tr>
                                  <tr>
